                      ...
                      <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr class="text-center cart-<?php echo $item['rowid']; ?>">
                              ...
                              <td class="price"><?php echo format_rupiah($item['price']); ?></td>
                              ...
                              <td class="total"><?php echo format_rupiah($item['subtotal']); ?></td>
                            </tr><!-- END TR-->
                              <?php endforeach; ?>
                          </tbody>
                        </table>
          ...
          <div class="row justify-content-end">
              ...
              <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                  <div class="cart-total mb-3">
                      ...
                      <p class="d-flex">
                          <span>Subtotal</span>
                          <span class="n-subtotal font-weight-bold"><?php echo format_rupiah($total_cart); ?></span>
                      </p>
                      <hr>
                      <p class="d-flex total-price">
                          <span>Total</span>
                          <span class="n-total font-weight-bold"><?php echo format_rupiah($total_cart); ?></span>
                      </p>
                  </div>
