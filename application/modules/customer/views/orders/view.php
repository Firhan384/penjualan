    ...
    <section class="content">
        <div class="row">
            <div class="col-md-8">
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            ...
                            <?php
                            if (get_order_status($data->order_status, $data->payment_method) === 'Dalam pengiriman' && $delivery_data->no_resi !== NULL) :
                            ?>
                                <tr>
                                    <td>No Resi</td>
                                    <td><b class="statusField"><?php echo $delivery_data->no_resi ?></b></td>
                                </tr>
                            <?php
                            endif;
                            ?>
                ...
                <?php
                if ($delivery_data->no_resi !== NULL) :
                    $historical = json_decode(api_logistic($delivery_data->logistic, $delivery_data->no_resi));
                    if ($historical !== NULL) :
                        if ($historical->valid === true) :
                ?>
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h5 class="card-heading">History Pengiriman</h5>
                                </div>
                                <div class="card-body p-0">
                                    <table class="table table-hover table-condensed">
                                        <tr>
                                        ...
                                        <?php foreach ($historical->body->history as $item) : ?>
                                            <tr>
                                                <td>
                                                    <?= $item->tanggal ?>
                                                </td>
                ...
                <?php
                        ...
                        echo '<p> terjadi kesalahan pada no awb </p>';
                    endif;
                endif;
                ?>
            </div>
