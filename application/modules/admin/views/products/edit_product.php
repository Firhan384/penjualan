      ...
      <div class="card-wrapper">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <label class="form-control-label" for="name">Berat produk(KG):</label>
              <input type="text" name="weight" value="<?php echo set_value('weight', $product->weight); ?>" class="form-control" id="weight">
