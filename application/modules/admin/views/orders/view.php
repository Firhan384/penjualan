            ...
            <table class="table align-items-center table-flush table-striped">
              ...
              <tr>
                ...
                <td>
                  ...
                  ?>
                  <form action="<?php echo site_url('admin/orders/update_no_resi/'. $data->id); ?>" method="post">
                    <div class="d-flex">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body p-0">
          <table class="table align-items-center table-flush table-hover">
            ...
            <tr>
              <td>Logistic</td>
              <td><b><?php echo $delivery_data->logistic; ?></b></td>
            </tr>
            <tr>
              <td>Biaya Kirim</td>
              <td><b><?php echo $delivery_data->cost_delivery; ?></b></td>
            </tr>
            <tr>
              <td>Estimasi Pengiriman</td>
              <td><b><?php echo $delivery_data->estimasi; ?></b></td>
            </tr>
            <tr>
              <td>Catatan</td>
